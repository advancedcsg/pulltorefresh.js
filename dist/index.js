...
function setupDOM(handler) {
  if (!handler.ptrElement) {
    ...
    if (document.querySelector('mosaic-container[navbar]') && document.querySelector('mosaic-container[navbar]').hasAttribute('fixed') || document.querySelector('mosaic-navbar') && document.querySelector('mosaic-navbar').hasAttribute('fixed-top')) {
    ...
    ptr.classList.add(((handler.classPrefix) + "ptr")); // ptr.innerHTML = handler.getMarkup()
